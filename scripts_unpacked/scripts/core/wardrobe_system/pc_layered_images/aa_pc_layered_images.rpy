...
layeredimage pc_old:  
    ...
    if player.prop == "beerl" or player.prop == "beerb":
    ...
    if acc.nails == 1 and player.prop == "" and not player.cover_vagina:
        "polish_left_layered"
    ...
    if acc.lipstick == 1 and acc.makeup_on == True and not acc.gagged:
        "pc_lipstick_layer"
    ...
    if player.cover_breasts:
        "body_armleft_cover_front_base"
    if player.cover_breasts:
        "body_armleft_cover_front_shad"
    if acc.nails == 1 and player.cover_breasts:
    ...
    if weather_var in (3,4) and loc_cur.outside == True:
        "body_armright_umb_back"
    elif player.prop in rarm_beer:
    ...
    if acc.nails == 1 and player.cover_vagina:
        "polish_right_cover_layered"
    elif acc.nails == 1 and player.cover_breasts:
        "polish_right_coverb_layered"
    elif (acc.nails == 1 and player.prop == "") and not (weather_var in (3,4) and loc_cur.outside == True):
    ...
    elif player.prop == "beerr" or player.prop == "beerb":
